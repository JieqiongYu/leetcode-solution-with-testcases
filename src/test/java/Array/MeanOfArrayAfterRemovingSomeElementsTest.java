...
public class MeanOfArrayAfterRemovingSomeElementsTest {
    @Mock
    private MeanOfArrayAfterRemovingSomeElements solution;

    @Before
    public void setUp() {
        solution = new MeanOfArrayAfterRemovingSomeElements();
    }
    ...
    public void testcase1() {
        ...
        assertEquals(expected, solution.trimMean(arr), 0);
    }

    @Test
    public void testcase2() {
        int[] arr = {6, 2, 7, 5, 1, 2, 0, 3, 10, 2, 5, 0, 5, 5, 0, 8, 7, 6, 8, 0};
        double expected = 4.0000;
        assertEquals(expected, solution.trimMean(arr), 0);
    }
